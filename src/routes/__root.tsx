  ...
  head: () => ({
    meta: [
      ...
      { title: "Adeyemi Erioluwa Daniel | Product Builder and Founder" },
      {
        name: "description",
        content:
          "Portfolio of Adeyemi Erioluwa Daniel, Computer Science student, founder of Conversion Alchemist and builder of MyAcumen.",
      },
      { name: "author", content: "Adeyemi Erioluwa Daniel" },
